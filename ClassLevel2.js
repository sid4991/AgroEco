...
var roi = /* color: #00ffff */ee.Geometry.Point([-117.14937090735943, 46.72281677669114]);
...
var chart = ui.Chart.image.series({
  imageCollection: withNDVI.select('NDVI'),
  region: roi,
  reducer: ee.Reducer.first(), //if it was polygon prefer mean to avoid cloud masking
  scale: 30
...
// Earth Engine includes a cloud-masking algorithm for Landsat sensors with a thermal band: 
